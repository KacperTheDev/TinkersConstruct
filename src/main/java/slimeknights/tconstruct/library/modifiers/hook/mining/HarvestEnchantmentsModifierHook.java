  ...
  static ItemEnchantments updateHarvestEnchantments(IToolStackView tool, ItemStack stack, ToolHarvestContext context) {
    ...
    if (player == null || !player.isCreative()) {
          ...
          for (ModifierEntry entry : armor.getModifierList()) {
            ...
            if (hook != null) {
              ...
              if (enchantments == null) {
                ...
                enchantments = new HashMap<>(originalEnchants.size());
                for (var enchantmentEntry : originalEnchants.entrySet()) {
                  enchantments.put(enchantmentEntry.getKey(), enchantmentEntry.getIntValue());
                }
              }
      ...
      if (enchantments != null) {
        ...
        ItemEnchantments.Mutable updated = new ItemEnchantments.Mutable(originalEnchants);
        Map<Holder<Enchantment>,Integer> finalEnchantments = enchantments;
        updated.removeIf(holder -> !finalEnchantments.containsKey(holder));
