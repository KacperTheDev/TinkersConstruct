...
public class ToolTankHelper {
  ...
  public static final BiFunction<CompoundTag, String, FluidStack> PARSE_FLUID =
    (nbt, key) -> FluidStack.parseOptional(RegistryAccessUtil.getRegistryAccess(), nbt.getCompound(key));
  ...
  public FluidStack setFluid(IToolStackView tool, FluidStack fluid) {
    ...
    tool.getPersistentData().put(fluidKey, fluid.save(RegistryAccessUtil.getRegistryAccess(), new CompoundTag()));
    return fluid;
  }
}
