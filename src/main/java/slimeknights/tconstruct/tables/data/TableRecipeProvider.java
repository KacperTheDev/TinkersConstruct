  ...
  private void tableRecipes(RecipeOutput consumer) {
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, TinkerTables.craftingStation)
        ...
        .pattern("w")
        .unlockedBy("has_item", has(TinkerTables.pattern)))
      .setSource(Ingredient.of(ItemTags.LOGS))
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, TinkerTables.partBuilder)
        ...
        .pattern("ww")
        .unlockedBy("has_item", has(TinkerTables.pattern)))
      .setSource(Ingredient.of(TinkerTags.Items.PLANKLIKE))
      .setMatchAll()
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      ...
      .setSource(Ingredient.of(TinkerTags.Items.WORKSTATION_ROCK))
      .setMatchAll()
    ...
    ShapedRetexturedRecipeBuilder.fromShaped(
      ...
      .setSource(Ingredient.of(TinkerTags.Items.ANVIL_METAL))
      .setMatchAll()
    ...
    RecipeOutput toolForge;
    {
      ...
      display.putString("Name", Serializer.toJson(Component.translatable("block.tconstruct.tool_forge"), lookupProvider.join()));
