...
public class ItemTagProvider extends ItemTagsProvider {
  ...
  private void addCommon() {
    ...
    ResourceLocation amethystStorageBlock = commonResource("storage_blocks/amethyst");
    ...
    for (DyeColor color : DyeColor.values()) {
      ResourceLocation name = commonResource("dyed/" + color.getSerializedName());
  ...
  private TagKey<Item> getArmorTag(ArmorItem.Type slotType) {
    return switch (slotType) {
      ...
      case HELMET -> HELMETS;
      case BODY -> throw new IllegalArgumentException("Body armor is not part of a player armor set");
    };
  }
