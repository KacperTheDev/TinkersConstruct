...
public class MaterialRecipeProvider extends BaseRecipeProvider implements IMaterialRecipeHelper {
  public MaterialRecipeProvider(PackOutput packOutput, java.util.concurrent.CompletableFuture<net.minecraft.core.HolderLookup.Provider> lookupProvider) {
  ...
  private void addMaterialItems(RecipeOutput consumer) {
    ...
    materialRecipe(consumer, MaterialIds.quartz, Ingredient.of(TinkerTags.Items.STORAGE_BLOCKS_QUARTZ), 4, 1, folder + "quartz/block");
