...
public class DoubleJumpModifier extends Modifier {
  ...
  protected void registerHooks(Builder hookBuilder) {
    ...
    hookBuilder.addModule(AttributeModule.builder(TinkerAttributes.JUMP_COUNT.value(), Operation.ADD_VALUE).slots(ARMOR_SLOTS).tooltipStyle(TooltipStyle.NONE).flat(1));
  }
