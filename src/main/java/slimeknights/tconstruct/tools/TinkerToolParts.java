...
public final class TinkerToolParts extends TinkerModule {
  ...
  // loot
  public static final DeferredHolder<LootPoolEntryType, ? extends LootPoolEntryType> toolPartLootEntry = LOOT_ENTRIES.register("tool_part", () -> new LootPoolEntryType(ToolPartLootEntry.CODEC));
