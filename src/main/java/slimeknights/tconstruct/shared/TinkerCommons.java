...
public final class TinkerCommons extends TinkerModule {
  ...
  /* Loot conditions */
  public static final DeferredHolder<LootItemConditionType, ? extends LootItemConditionType> lootConfig = LOOT_CONDITIONS.register(ConfigEnabledCondition.ID.getPath(), () -> new LootItemConditionType(ConfigEnabledCondition.CODEC));
  public static final DeferredHolder<LootItemConditionType, ? extends LootItemConditionType> lootBlockOrEntity = LOOT_CONDITIONS.register("block_or_entity", () -> new LootItemConditionType(BlockOrEntityCondition.CODEC));
  public static final DeferredHolder<LootItemConditionType, ? extends LootItemConditionType> hasLootContextSet = LOOT_CONDITIONS.register("has_context_set", () -> new LootItemConditionType(HasLootContextSetCondition.CODEC));
  /** @deprecated use {@link slimeknights.mantle.loot.MantleLoot#TAG_FILLED} */
  @SuppressWarnings("removal")
  @Deprecated(forRemoval = true)
  public static final DeferredHolder<LootItemConditionType, ? extends LootItemConditionType> lootTagNotEmptyCondition = LOOT_CONDITIONS.register("tag_not_empty", () -> new LootItemConditionType(TagNotEmptyCondition.CODEC));
  /** @deprecated use {@link slimeknights.mantle.loot.MantleLoot#TAG_PREFERENCE} */
  @SuppressWarnings("removal")
  @Deprecated(forRemoval = true)
  public static final DeferredHolder<LootPoolEntryType, ? extends LootPoolEntryType> lootTagPreference = LOOT_ENTRIES.register("tag_preference", () -> new LootPoolEntryType(TagPreferenceLootEntry.CODEC));
  ...
  void registerRecipeSerializers(RegisterEvent event) {
    if (event.getRegistryKey() == Registries.RECIPE_SERIALIZER) {
      ...
      event.register(net.neoforged.neoforge.registries.NeoForgeRegistries.Keys.CONDITION_CODECS, helper -> {
        ...
        helper.register(getResource("tag_not_empty"), TagNotEmptyCondition.CODEC);
      });
  ...
  void gatherData(final GatherDataEvent event) {
    ...
    generator.addProvider(event.includeServer(), new CommonRecipeProvider(output, event.getLookupProvider()).named());
  }
