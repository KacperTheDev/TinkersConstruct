...
class MaterialTraitsManagerTest extends BaseMcTest {
  ...
  private final MergingJsonFileLoader<MaterialTraits.Builder> fileLoader = new MergingJsonFileLoader<>(traitsManager, MaterialTraitsManager.GSON, MaterialTraitsManager.FOLDER);
